...
escape_javascript(Data, Input, Skip) ->
    escape_javascript(Data, [], Input, Skip).
...
escape_javascript(<<Byte/integer,Rest/bitstring>>,
    ...
    when Byte =:= 0 ->
    Acc2 = [Acc | escape(Byte)],
    escape_javascript(Rest, Acc2, Input, Skip + 1);
escape_javascript(<<Byte/integer,Rest/bitstring>>,
                  Acc, Input, Skip)
    when Byte =:= 1 ->
    Acc2 = [Acc | escape(Byte)],
...
escape_javascript(<<Byte/integer,Rest/bitstring>>,
                  Acc, Input, Skip)
    when Byte =:= 32 ->
    escape_javascript_chunk(Rest, Acc, Input, Skip, 1);
escape_javascript(<<Byte/integer,Rest/bitstring>>,
                  Acc, Input, Skip)
    when Byte =:= 33 ->
    escape_javascript_chunk(Rest, Acc, Input, Skip, 1);
...
escape_javascript(<<Char/utf8,Rest/bitstring>>,
                  Acc, Input, Skip)
    when Char =< 2047 ->
    escape_javascript_chunk(Rest, Acc, Input, Skip, 2);
escape_javascript(<<8232/utf8,Rest/bitstring>>,
                  Acc, Input, Skip) ->
    Acc2 = [Acc | <<"\\u2028">>],
    escape_javascript(Rest, Acc2, Input, Skip + 3);
...
escape_javascript(<<Char/utf8,Rest/bitstring>>,
                  Acc, Input, Skip)
    when Char =< 65535 ->
    escape_javascript_chunk(Rest, Acc, Input, Skip, 3);
escape_javascript(<<_Char/utf8,Rest/bitstring>>,
                  Acc, Input, Skip) ->
    escape_javascript_chunk(Rest, Acc, Input, Skip, 4);
escape_javascript(<<>>, Acc, _Input, _Skip) ->
    Acc;
...
escape_javascript_chunk(<<Byte/integer,Rest/bitstring>>,
    ...
    Part = binary_part(Input, Skip, Len),
    Acc2 = [Acc, Part | escape(Byte)],
    escape_javascript(Rest, Acc2, Input,
                      Skip + Len + 1);
escape_javascript_chunk(<<Byte/integer,Rest/bitstring>>,
                        Acc, Input, Skip, Len)
    when Byte =:= 1 ->
...
escape_javascript_chunk(<<Byte/integer,Rest/bitstring>>,
                        Acc, Input, Skip, Len)
    when Byte =:= 32 ->
    escape_javascript_chunk(Rest, Acc, Input, Skip,
                            Len + 1);
escape_javascript_chunk(<<Byte/integer,Rest/bitstring>>,
                        Acc, Input, Skip, Len)
    when Byte =:= 33 ->
...
escape_javascript_chunk(<<_Char/utf8,Rest/bitstring>>,
    ...
    escape_javascript_chunk(Rest, Acc, Input, Skip,
                            Len + 4);
escape_javascript_chunk(<<>>, Acc, Input, Skip, Len) ->
    Part = binary_part(Input, Skip, Len),
    [Acc | Part];
